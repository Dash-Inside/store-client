...
import 'package:store_client/core/services/services.dart' as _i9;
...
import 'package:store_client/src/domain/usecases/user_data/restore_password_usecase.dart'
    as _i23;
import 'package:store_client/src/presentation/app.dart' as _i34;
import 'package:store_client/src/presentation/bloc/auth/auth_bloc.dart' as _i32;
import 'package:store_client/src/presentation/pages/account_page.dart' as _i3;
import 'package:store_client/src/presentation/pages/chat_page.dart' as _i8;
import 'package:store_client/src/presentation/pages/library_page.dart' as _i14;
import 'package:store_client/src/presentation/pages/log_in_page.dart' as _i33;
import 'package:store_client/src/presentation/pages/markdown_page.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt generate({
    ...
    gh.factory<_i8.ChatPage>(() => _i8.ChatPage());
    gh.factory<_i9.DioModule>(() => _i9.DioModule());
    gh.factory<_i10.FetchMessagesUseCase>(() => _i10.FetchMessagesUseCase());
    gh.factory<_i11.GetAllSectionsUseCase>(() => _i11.GetAllSectionsUseCase());
    gh.factory<_i12.GetAllTopicsBySectionIDUseCase>(
        () => _i12.GetAllTopicsBySectionIDUseCase());
    gh.factory<_i13.GetTopicByIDUseCase>(() => _i13.GetTopicByIDUseCase());
    gh.factory<_i14.LibraryPage>(() => _i14.LibraryPage());
    gh.factory<_i15.LibraryRepository>(() => _i16.LibraryServerRepository());
    gh.factory<_i17.LibraryServerDatasource>(
        () => _i17.LibraryServerDatasource());
    gh.factory<_i18.LogInUseCase>(() => _i18.LogInUseCase());
    gh.factory<_i19.MarkdownPage>(() => const _i19.MarkdownPage());
    ...
    gh.factory<_i9.SecureModule>(() => _i9.SecureModule());
    gh.factory<_i25.SendMessageUsecase>(() => _i25.SendMessageUsecase());
    gh.factory<_i26.UserServerDatasource>(() => _i26.UserServerDatasource(
          dioModule: gh<_i9.DioModule>(),
          secureModule: gh<_i9.SecureModule>(),
        ));
    gh.factory<_i27.MessengerRepository>(() => _i28.MessengerServerRepository(
        messengerServerDatasource: gh<_i20.MessengerServerDatasource>()));
    gh.factory<_i29.UserRepository>(() => _i30.UserServerRepository(
        userServerDatasource: gh<_i26.UserServerDatasource>()));
    gh.factory<_i31.RecheckTokenUseCase>(() =>
        _i31.RecheckTokenUseCase(userRepository: gh<_i29.UserRepository>()));
    gh.singleton<_i32.AuthBloc>(_i32.AuthBloc(
      recheckTokenUseCase: gh<_i31.RecheckTokenUseCase>(),
      logInUseCase: gh<_i18.LogInUseCase>(),
    ));
    gh.factory<_i33.LoginPage>(
        () => _i33.LoginPage(authBloc: gh<_i32.AuthBloc>()));
    gh.factory<_i34.App>(() => _i34.App(authBloc: gh<_i32.AuthBloc>()));
    return this;
  }
}
