...
abstract class LibraryRepository {
  ...
  Future<Either<Failure, Unit>> addFavoriteTopic({
    required int id,
  });
  ...
  Future<Either<Failure, Unit>> removeFavoriteTopic({
    required int id,
  });
  ...
  Future<Either<Failure, List<Topic>>> getAllTopicsBySectionID({
    required int id,
  });
  ...
  Future<Either<Failure, Topic>> getTopicDataByID({
    required int id,
  });
